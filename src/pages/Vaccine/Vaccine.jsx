...
const Vaccine = () => {
  ...
  return (
    <form
      ...
      className="px-40 w-full h-full bg-bgMain text-primaryText overflow-x-hidden"
    >
        ...
        <div>
            ...
            <div className="flex flex-col justify-center pl-6">
              <label className="flex items-center h-10 text-xl">
                <input
                  ...
                  value="true"
                  checked={applicant.had_vaccine === true}
                  name="had_vaccine"
                />
                კი
              </label>
              <label className="flex items-center h-10 text-xl">
                <input
                  ...
                  className="mr-5 appearance-none w-6 h-6 rounded-full border border-gray-900 checked:border-gray-900"
                  value="false"
                  checked={applicant.had_vaccine === false}
                  name="had_vaccine"
                />
                არა
              </label>
              <p
                className={
                  applicant.had_vaccine !== null ? "hidden" : "text-error"
                }
              >
              ...
              <div className="flex flex-col justify-center pl-6">
                ...
                <label className="flex items-center h-10 text-xl">
                  <input
                    ...
                    checked={applicant.vaccination_stage === "fully_vaccinated"}
                    name="vaccination_stage"
                  />
                  სრულად აცრილი ვარ
                </label>
              ...
              <div className="flex flex-col justify-center pl-6">
                <label className="flex items-center h-10 text-xl">
                  <input
                    ...
                    checked={
                      applicant.i_am_waiting === "registered_and_waiting"
                    }
                    name="i_am_waiting"
                  />
                ...
                <label className="flex items-center h-10 text-xl">
                  <input
                    ...
                    className="mr-5 appearance-none w-6 h-6 rounded-full border border-gray-900 checked:border-gray-900"
                    value="not_planning"
                    checked={applicant.i_am_waiting === "not_planning"}
                    name="i_am_waiting"
                  />
                  არ ვგეგმავ
                </label>
          ...
          "first_dosage_and_not_registered_on_the_second" ? (
            <p className="w-96 pl-16 text-xl mt-10">
              ...
              <a className="block text-link" href="https://booking.moh.gov.ge/">
      ...
      <div className="flex items-center justify-center">
        <button onClick={() => navigate("/covid")} className="mr-28">
