...
const officeSchema = yup.object().shape({
    non_formal_meetings: yup.string().required("ამ ველის შევსება აუცილებელია").oneOf(["twice_a_week", "once_a_week", "bi_weekly", "once_a_month"], 'გთხოვთ აირჩიოთ შესაბამისი ვარიანტი'),
